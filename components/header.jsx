                ...
                <div className="container mx-auto px-12 py-6 md:py-0">
                    <div className="h-[90vh] grid grid-cols-12 content-center">
                        <div className="col-span-12 xl:col-span-6">
                            <h4 className="text-amareloastro-500 font-semibold text-xl my-5 transform duration-1000">Bem vindo a Astrocrypto</h4>
                            <h1 className="text-cinzaastro-300 leading-none font-light text-5xl mb-10">Descubra o mundo das moedas digitais!</h1>
                            <p className="mb-12 text-justify text-amareloastro-700">Descubra todos os segredos do mundo das moedas digitais com o foco na inovação; a Astrocrypto disponibiliza um método de aprendizado baseado na prática.</p>
